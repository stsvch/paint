...
- Хранит коллекцию доступных рисунков (например, `HumanDrawing`)
...
> Ранее в проекте был рисунок "Цветок". Он удален, чтобы сфокусироваться на одной фигуре и упростить логику заливки.
